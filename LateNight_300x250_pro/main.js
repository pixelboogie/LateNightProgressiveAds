...
vid_tl
	...
	.from(vid_tt, 1, {scale:.9, transformOrigin:"30% 90%", ease:Elastic.easeOut}, 0)
...
end_tl
	...
	.from(end_txt2, .5, {alpha:0, ease:Power1.easeOut}, .3)
	
	//------------ tt
	.add("t1", .25)
	.from(end_tt, .1, {alpha:0, ease:Power0.easeIn}, "t1")
	.from(end_tt, 1.75, {scale:.95, transformOrigin:"30% 40%", ease:Elastic.easeOut}, "t1")
